...
export DEB_CONTAINERS=auto-debian11-arm,auto-ubuntu2204
...
```bash
# Debian
docker run -d --name auto-debian11-arm debian:11 tail -f /dev/null
...
| `DEB_CONTAINERS` | Debian container names | `auto-debian11-arm` |
